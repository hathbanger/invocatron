...
InvocaBot.prototype._replyWithRandomJoke = function (originalMessage) {
    ...
    function recursive_invoca_request(date, lastElId, count){
        ...
        // if(lastElId == ''){
            request('https://connectyourhome.invoca.net/api/2016-10-01/networks/transactions/1219.json?from='+date+'&to='+date+'&limit=4000&oauth_token=nh0CXzxYurjFS_vX20GqScRpNOz7jB0c', function(err, response, body){
                console.log(err);
        ...
        // }
        // else{
        //     var r = request.get('https://connectyourhome.invoca.net/api/2016-10-01/networks/transactions/1219.json?from='+date+'&to='+date+'&limit=4000&start_after_transaction_id='+ lastElId +'&oauth_token=nh0CXzxYurjFS_vX20GqScRpNOz7jB0c')
        //     var arrayLen = r.length
        //     count = count + arrayLen
        //     console.log(count);
        //     console.log('r: ', r);
